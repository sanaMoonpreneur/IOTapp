...
const styles = StyleSheet.create({
    ...
    closeButton: { width: 40, height: 40, justifyContent: 'center', alignItems: 'center', marginBottom: 30, borderRadius: 10, margin: 10, backgroundColor: "#f58084", },
    ...
    rbSheetContainer: { backgroundColor: "#f58084", borderTopRightRadius: 70, borderTopLeftRadius: 70, paddingVertical: 30, height: '50%', },
    sheetContent: { alignItems: 'center' },
    lottie: { width: 200, height: 200 },
    exitText: { color: "white", fontSize: 17, fontWeight: "bold", textAlign: 'center' },
    button: { backgroundColor: "#FFF2F2", alignItems: "center", marginTop: 20, width: 100, paddingVertical: 10, borderRadius: 14, paddingHorizontal: 10, },
