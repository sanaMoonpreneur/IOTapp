...
const styles = StyleSheet.create({
  ...
  headerContainer: { flexDirection: "row", width: "100%", paddingHorizontal: 20, marginTop: 30, justifyContent: 'space-between' },
  ...
  title: { color: "white", fontSize: 35, fontWeight: "bold", textAlign: "center", marginTop: 20 },
  inputContainer: { marginHorizontal: 20, marginTop: 20, },
  label: { fontSize: 20, fontWeight: "bold", marginBottom: 5, marginLeft: 10, color: '#345c74', },
  input: { borderRadius: 30, height: 50, paddingHorizontal: 10, backgroundColor: '#ecf0f1', color: '#2c3e50', fontWeight: "400", },
  addButton: { marginTop: 15, alignSelf: 'center', paddingVertical: 10, height: 45, width: '50%', paddingHorizontal: 20, backgroundColor: 'white', borderRadius: 25, marginBottom: 10, elevation: 5, },
  addButtonText: { color: '#EC8588', fontSize: 20, textAlign: 'center', fontWeight: "500", }
});
